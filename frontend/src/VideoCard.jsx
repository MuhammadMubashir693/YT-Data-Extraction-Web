    ...
    <div className="video-card">
      ...
      <div className="body">
        ...
        <div className="meta-grid">
          ...
          {v.defaultLanguage !== "N/A" && (<span><b>Default language:</b> {v.defaultLanguage}</span>)}
          {v.defaultAudioLanguage !== "N/A" && (<span><b>Default audio language:</b> {v.defaultAudioLanguage}</span>)}
